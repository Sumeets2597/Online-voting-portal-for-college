...
<!--Navigation-->
  <nav class="main-header clearfix" role="navigation"> <a class="navbar-brand" href="index.html"><span class="text-blue">Login</span></a> 
  ...
  <div class="main-wrap"> 
    ...
    <div class="responsive-admin-menu">
      ...
      <ul id="menu">
        <li><a href="index.html" title="Dashboard">
		<i class="entypo-briefcase"></i><span> HOME</span></a></li>
        <li><a class="submenu active" href="#" title="Consession Form" data-id="Consession Form">
			<i class="entypo-users"></i><span>Council Login</span></a>
...
<div class="breadcrumb clearfix">
            <ul>
              <li><a href="HomePage.php"><i class="fa fa-home"></i></a></li>
		...
		<div class="col-md-12 bootstrap-grid">
            ...
            <div class="powerwidget green" id="add-customer-form-validation-widget" data-widget-editbutton="false">
              ...
              <div class="inner-spacer">
                <!--<form action="minal.php" class="orb-form"  method="POST">-->
		...
		<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-md-12"><br>
					...
					<div class="panel-group" id="panel-928827">

						<div class="panel panel-default">

							<div class="panel-heading">

								 <a class="panel-title collapsed" data-toggle="collapse" data-parent="#panel-928827" href="#panel-element-67705">Council Login</a>
								...
								<div class="panel-body">
									...
									<form name="admin_login" id = "admin_login" action="councilloginconnect.php" class="orb-form" method="post">
						...
						<footer>
                    <button type="submit" class="btn btn-default" value="Login" name="Submit"><font size="5">Login</font></button>
		                 </footer>
