...
if(isset($_COOKIE[session_name()])){
    //empty the cookie
    setcookie(session_name(),"",time()-86400,'/');//30*86400 is number of seconds in a day
...
echo" <p><a href='Register.php'>Log Back In....</a></p>  ";
						...
						<ul class="nav navbar-nav menu__list">
							...
							<li class="dropdown menu__item">
								...
								<ul class="dropdown-menu agile_short_dropdown">
									...
									<li><a href="typography.html">Council</a></li>
								</ul>
							</li>
