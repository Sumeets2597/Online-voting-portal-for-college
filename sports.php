...
<!--Navigation-->
  ...
  <div class="main-wrap"> 
    ...
    <i class="entypo-briefcase"></i><span>GS</span></a></li>
        <li><a class="submenu active" href="sports.php" title="sports">
    <i class="entypo-briefcase"></i><span>Sports</span></a></li>
    <li><a href="cultural.php" title="cultural">
		...
		<div class="col-md-12 bootstrap-grid">
            ...
            <div class="powerwidget green" id="add-customer-form-validation-widget" data-widget-editbutton="false">
              ...
              <div class="inner-spacer">
                <form action="sportsregister.php" id="stud_form" name="stud_form" class="orb-form"  method="POST">
