...
<!--Navigation-->
  ...
  <div class="main-wrap"> 
    ...
    <i class="entypo-briefcase"></i><span>GS</span></a></li>
        <li><a  href="applypost.php" title="Junior">
    <i class="entypo-briefcase"></i><span>Junior</span></a></li>
    <li><a class = "submenu active" href="junior.php" title="Senior">
        ...
        <section class="col col-10">
                      <label class="select">
                        <select id="class" name="class">
                          <option value="D6">D12</option>
                          <option value="D7">D13</option>
              <option value="D8">D14</option>
              <option value="D9">D15</option>
                          <option value="D10">D16</option>
        ...
        <section class="col col-10">
                      <label class="select">
                        <select id="post" name="post">
                          <option value="senior sports secretary">Senior Sports Secretary</option>
                          <option value="senior sports deputy secretary " >Senior Sports Deputy Secretary</option>
                          <option value="senior cultural secretary" >Senior Cultural Secretary</option>
                          <option value="senior cultural deputy secretary" >Senior Cultural Deputy Secretary</option>
                          <option value="senior music secretary" >Senior Music Secretary</option>
                          <option value="senior music deputy secretary" >Senior Music Deputy Secretary</option>
                          <option value="senior sout secretary" >Senior Sout Secretary</option>
                          <option value="senior sout deputy secretary" >Senior Sout Deputy Secretary</option>
                          <option value="senior eall secretary" >Senior Eall Secretary</option>
                          <option value="senior eall deputy secretary" >Senior Eall Deputy Secretary</option>
